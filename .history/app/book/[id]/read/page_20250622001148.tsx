...
// Set up PDF.js worker - disable worker for now to avoid loading issues
if (typeof window !== 'undefined') {
  // Create a minimal worker using a data URL to avoid external dependencies
  const workerCode = `
    // Minimal PDF.js worker fallback
    self.onmessage = function(e) {
      // Basic message handling - this is a simplified worker
