...
// Disable PDF.js worker to run in main thread (legacy mode)
if (typeof window !== 'undefined') {
  // Set workerSrc to empty string to disable worker and run in main thread
  // This is slower but avoids worker loading issues
