...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">{/* Removed dark theme classes */}
      {/* Header/Navigation */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Optimized Reading</h3>
              <p className="text-gray-600">
                Clean, distraction-free light mode interface optimized for comfortable reading in any environment.
              </p>
            </div>
          </div>
        </div>
